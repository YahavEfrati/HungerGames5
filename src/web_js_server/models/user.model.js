...
class UserModel {
     ...
     * @param {Object} updatedFields - Fields containing the updated details.
    ...
    updateUser(id, updatedFields) {
        ...
        // Merge the new fields into the user object (excluding id and username for safety)
        const { id: _, username: __, ...fieldsToUpdate } = updatedFields;
