...
class RestaurantModel {
     ...
     * @param {number} restaurantData.addressX - The X coordinate of the restaurant's address.
     * @param {number} restaurantData.addressY - The Y coordinate of the restaurant's address.
     ...
     * @param {string} restaurantData.working_hours - The working hours of the restaurant.
     * @param {string} restaurantData.image - The URL of the restaurant's cover image.
     * @param {Array<string>} restaurantData.categories - An array of category names associated with the restaurant.
    ...
    createRestaurant(restaurantData) {
        ...
        const newRestaurant = {
            ...
            addressX: restaurantData.addressX,
            addressY: restaurantData.addressY,
            ...
            minimumOrder: restaurantData.minimumOrder !== undefined ? restaurantData.minimumOrder : 15,
